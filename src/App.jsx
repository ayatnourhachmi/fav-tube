...
import CutterPage from './CutterPage'; // Import the CutterPage component
...
function App() {
  ...
  const [activeTab, setActiveTab] = useState('home'); // 'home', 'cutter', or 'transcript'
  ...
  // Placeholder components for Cutter and Transcript features
  const CutterTab = () => (
    <div className="bg-gradient-to-br from-red-100/90 to-red-50/90 backdrop-blur-lg rounded-3xl shadow-xl p-8 border border-red-200">
      <div className="text-center">
        <Scissors className="w-16 h-16 mx-auto text-red-600 mb-4" />
        <h2 className="text-2xl font-bold text-gray-800 mb-2">FavTUBE Cutter</h2>
        <p className="text-gray-600">Trim and cut your YouTube videos to the perfect length.</p>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-100 via-red-50 to-emerald-50 relative overflow-hidden">
      {/* Add the navbar component with a callback to change the active tab */}
